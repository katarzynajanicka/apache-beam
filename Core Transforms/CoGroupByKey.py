...
# Implement a CoGroupByKey transform that joins words by the first alphabetical letter,
# # and then produces the string representation of the WordsAlphabet model
